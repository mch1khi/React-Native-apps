...
import Animated, { SlideInDown, useAnimatedRef, useAnimatedStyle, useScrollViewOffset, interpolate } from 'react-native-reanimated';
      ...
      <Animated.View style={defaultStyles.footer} entering={SlideInDown.delay(200)} >
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <TouchableOpacity style={styles.footerText}>
            <Text style={styles.footerPrice}>Є{listing?.price}</Text>
            <Text>night</Text>
          </TouchableOpacity>
